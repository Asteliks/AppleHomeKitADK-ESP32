...
#define kIID_LightBulb                 ((uint64_t) 0x0044)
#define kIID_LightBulbServiceSignature ((uint64_t) 0x0045)
#define kIID_LightBulbName             ((uint64_t) 0x0046)
#define kIID_LightBulbOn               ((uint64_t) 0x0047)
