...
//    HAPAccessoryServerStart(accessoryConfiguration.server, &accessoryb);
//    void HAPAccessoryServerStart(HAPAccessoryServerRef* server, const HAPAccessory* accessory);
    HAPAccessoryServerStartBridge(accessoryConfiguration.server, &accessory[0], accessory ,false);
}
